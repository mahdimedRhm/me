...
<body class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
    ...
    <!-- Projects Section -->
    <section id="projects" class="py-20 px-6 bg-black/20">
        <div class="container mx-auto">
            <h2 class="text-4xl font-bold text-white text-center mb-12">Featured Projects</h2>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Project 1 -->
                <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-lg overflow-hidden group hover:bg-white/10 transition-all duration-300">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-2">
                            <h3 class="text-white text-xl font-semibold">Charity Right</h3>
                            <div class="flex space-x-2">
                                <a href="https://app.charityright.org.uk/donate/" class="text-white/60 hover:text-purple-400">
                        ...
                        <p class="text-white/60 mb-4">Charity platform for managing donations and fundraising campaigns</p>
                        <div class="flex flex-wrap gap-2 mb-4">
                            <span class="border border-purple-400/50 text-purple-300 px-2 py-1 rounded text-sm">Laravel</span>
                            <span class="border border-purple-400/50 text-purple-300 px-2 py-1 rounded text-sm">Event Driven</span>
                            <span class="border border-purple-400/50 text-purple-300 px-2 py-1 rounded text-sm">MySQL</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Project 2 -->
                <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-lg overflow-hidden group hover:bg-white/10 transition-all duration-300">
                    <div class="w-full h-48 bg-gradient-to-br from-pink-500/20 to-red-500/20 flex items-center justify-center">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-2">
                            <h3 class="text-white text-xl font-semibold">Payme</h3>
                            <div class="flex space-x-2">
                                <a href="#" class="text-white/60 hover:text-purple-400">
                        ...
                        <p class="text-white/60 mb-4">Payment processing platform with Stripe integration</p>
                        <div class="flex flex-wrap gap-2 mb-4">
                            <span class="border border-pink-400/50 text-pink-300 px-2 py-1 rounded text-sm">Vue</span>
                            <span class="border border-pink-400/50 text-pink-300 px-2 py-1 rounded text-sm">Laravel</span>
                            <span class="border border-pink-400/50 text-pink-300 px-2 py-1 rounded text-sm">Stripe API</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Project 3 -->
                <div class="bg-white/5 border border-white/10 backdrop-blur-sm rounded-lg overflow-hidden group hover:bg-white/10 transition-all duration-300">
                    <div class="w-full h-48 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 flex items-center justify-center">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-2">
                            <h3 class="text-white text-xl font-semibold">Mulhouse Stationnement</h3>
                            <div class="flex space-x-2">
                                
                            </div>
                        </div>
                        <p class="text-white/60 mb-4">Parking management system for the city of Mulhouse</p>
                        <div class="flex flex-wrap gap-2 mb-4">
                            <span class="border border-blue-400/50 text-blue-300 px-2 py-1 rounded text-sm">Laravel</span>
                            <span class="border border-blue-400/50 text-blue-300 px-2 py-1 rounded text-sm">Vue.js</span>
                            <span class="border border-blue-400/50 text-blue-300 px-2 py-1 rounded text-sm">PostgreSQL</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="py-8 px-6 border-t border-white/10">
        <div class="container mx-auto text-center">
            <p class="text-white/60">© 2024 Mohamed El Mehdi RAHMOUN.</p>
        </div>
    </footer>
